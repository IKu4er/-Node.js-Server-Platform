...
## Переваги застосування Node.js
  1.
**Простий і широко відомий JavaScript** Звичайно, платформа передбачає власні інструменти та особливості, наприклад, тут немає браузерних API, coockie або DOM, зате присутні власні
бібліотеки та інші цікаві рішення. Але в основному використовуються можливості і синтаксис всім звичного JavaScript.
  2.
